...
namespace MYDENTIST.Class.DatabaseHelper
{
    ...
    public abstract class cds_BaseKonektor
    {
        public string koneksiString { get; set; }
        private cds_KoneksiString koneksiStringOption = null;
        ...
        public void SetKoneksiString(cds_KoneksiString option)
        {
            this.koneksiStringOption = option;
            this.koneksiString = option.ToString();
        }

        public void SetKoneksiString(string koneksiString)
        {
            this.koneksiString = koneksiString;
        }

        public cds_KoneksiString GetKoneksiOption()
        {
            return this.koneksiStringOption;
        }

        public string GetKoneksiString()
        {
            return this.koneksiString;
        }
        ...
        public bool OpenKoneksi(MySqlConnection mysqlConnection, int attempts)
        {
